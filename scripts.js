const getCurrent = async(lat,lon)=>{
    ...
    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=imperial&appid=8fc3ed674c714d5d4b58e24a9d0b5dcf`);
...
console.log(city);
 const response = await fetch(`http://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=10&appid=8fc3ed674c714d5d4b58e24a9d0b5dcf`);
 // get the body out of the response
